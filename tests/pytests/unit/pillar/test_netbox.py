...
def default_kwargs():
    return {
        "minion_id": "dmi01-akron-rtr01",
        "pillar": None,
        "api_url": "http://demo.netbox.dev",
            ...
            "results": [
                {
                    ...
                    "node_type": "device",  # added by pillar netbox.py, not netbox api
                    "platform": {
                        "id": 1,
            ...
            "results": [
                {
                    ...
                    "role": {
                        "id": 7,
                        "url": "https://demo.netbox.dev/api/dcim/device-roles/7/",
                    ...
                    "platform": {
                        "id": 3,
                        "url": "https://demo.netbox.dev/api/dcim/platforms/3/",
                        "display": "Ubuntu Linux 20.04",
                        "name": "Ubuntu Linux 20.04",
                        "slug": "ubuntu-linux-20-04",
                    },
                    "primary_ip": None,
                    "primary_ip4": None,
                    "primary_ip6": None,
                    ...
                    "custom_fields": {},
                    "config_context": {},
                    "created": "2021-04-05T00:00:00Z",
                    "last_updated": "2021-04-05T21:15:56.301000Z",
                }
            ],
        }
    }
    ...
    return {
        "dict": {
            ...
            "results": [
                ...
                {
                    "id": 362,
                    "url": "https://demo.netbox.dev/api/virtualization/virtual-machines/362/",
                    "display": "vm2",
                    "name": "vm2",
                    "status": {"value": "active", "label": "Active"},
                    "site": None,
                    ...
                    "config_context": {},
                    "created": "2021-04-05T00:00:00Z",
                    "last_updated": "2021-04-05T21:15:56.309000Z",
                },
            ],
        }
    }
    ...
    return {
        "dict": {
            ...
            "results": [
                    ...
                    "link_peers": [
                        {
                            ...
                            "display": "Termination Z: DM-Akron",
                            "circuit": {
                                "id": 1,
                ...
                {
                    "id": 4,
                    "url": "https://demo.netbox.dev/api/dcim/interfaces/4/",
                    ...
                    "lag": {
                        "id": 833,
                        "url": "https://demo.netbox.dev/api/dcim/interfaces/833/",
                        "display": "Po1",
                        "device": {
                            "id": 1,
                            "url": "https://demo.netbox.dev/api/dcim/devices/1/",
                    ...
                    "cable": {
                        "id": 36,
                        "url": "https://demo.netbox.dev/api/dcim/cables/36/",
                        "display": "#36",
                        "label": "",
                    },
                    "cable_end": "A",
                    ...
                    "link_peers": [
                        {
                            "id": 171,
                            "url": "https://demo.netbox.dev/api/dcim/interfaces/171/",
    ...
    return [
        {
            ...
            "url": "https://demo.netbox.dev/api/dcim/interfaces/1/",
            "display": "GigabitEthernet0/0/0",
            # if copying from netbox api, remove device block here
            # "device": {
            #     "id": 1,
            #     "url": "https://demo.netbox.dev/api/dcim/devices/1/",
            #     "display": "dmi01-akron-rtr01",
    ...
    return {
        "dict": {
            ...
            "results": [
                {
                    "id": 901,
                    "url": "https://demo.netbox.dev/api/virtualization/interfaces/901/",
                    "display": "eth0",
                    "virtual_machine": {
                        "id": 361,
                        "url": "https://demo.netbox.dev/api/virtualization/virtual-machines/361/",
                    ...
                    "custom_fields": {},
                    "created": "2021-04-14T00:00:00Z",
                    "last_updated": "2021-04-14T17:36:20.845000Z",
                    "count_ipaddresses": 0,
                    "count_fhrp_groups": 0,
                },
                {
